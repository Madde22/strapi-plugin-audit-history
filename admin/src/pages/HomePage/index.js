...
const HomePage = () => {
  ...
  const fetchData = async () => {
    console.log("Fetching data by all");
    setIsLoading(true);
                      ...
                      <Typography textColor="neutral800">
                        <Flex gap="2">
                          <Box>
                            <Typography textColor="neutral800">
                              {new Date(
                                auditLog.request.result.createdAt
                              ).toLocaleString()}
                            </Typography>
                          </Box>
                          <Box>
                          ...
                          <Box>
                            <Typography textColor="neutral800">
                              {new Date(
                                auditLog.request.params.data.updatedAt
                              ).toLocaleString()}
                            </Typography>
                          </Box>
                        </Flex>
              ...
              <Flex justifyContent="space-between">
                <Flex gap="5">
                  ...
                  <Box>
                    <Button
                      disabled={
                        activePage === Math.ceil(auditLogs.total / limit)
                      }
      ...
      {isInspectModalOpen && (
        ...
        >
          ...
          <ModalBody>
            ...
            <JSONInput
              disabled
              value={JSON.stringify(currentAuditLog.author, null, 2)}
            />
            <Typography variant="beta">Request</Typography>
            <JSONInput
              disabled
              value={JSON.stringify(currentAuditLog.request, null, 2)}
            />
            <Typography variant="beta">Params</Typography>
            <JSONInput
              disabled
              value={JSON.stringify(currentAuditLog.params, null, 2)}
            />
          </ModalBody>
        </ModalLayout>
      )}
